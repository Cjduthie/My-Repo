...
namespace UniversityofContoso.Models
{
    ...
    public class UniversityofContosoContext : DbContext
    {
        ...
        public UniversityofContosoContext() : base("name=UniversityofContosoContext")
        {

            Database.SetInitializer(new MigrateDatabaseToLatestVersion<UniversityofContosoContext, MyConfiguration>());
        }
        public class MyConfiguration : DbMigrationsConfiguration<UniversityofContosoContext>
        {
            ...
            protected override void Seed(UniversityofContosoContext context)
            {
